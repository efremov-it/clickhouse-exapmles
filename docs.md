...
```xml
<distributed_directory_monitor>
    <max_delay>300</max_delay> <!-- Максимальное время задержки отправки данных (в секундах) -->
    <max_size_in_bytes>1073741824</max_size_in_bytes> <!-- Максимальный размер данных в директории (1 ГБ) -->
    <sleep_time_ms>500</sleep_time_ms> <!-- Интервал повторных попыток отправки (0.5 сек) -->
    <max_files_to_send>100</max_files_to_send> <!-- Максимальное количество файлов для отправки за один раз -->
</distributed_directory_monitor>
